...
{
    public class ChargeCaptureRequest : HttpRequest
    {
        public ChargeCaptureRequest(string ChargeId) : base("/post-sale/charges/{charge_id}/settles", HttpMethod.Post, typeof(ChargeCapture))
        {
            try
            {
        ...
        public ChargeCaptureRequest RequestBody(CaptureRequest captureRequest)
        {
